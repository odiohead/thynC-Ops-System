...
> **상태: dev 반영 완료 (빌드·재시작·백필 적용 2026-09-17) — 화면 확인·PROD 배포 대기** (§13 구현 노트) · 작성 2026-09-17 · 개정 2.1(2026-09-17 — 1차 적대 검증 43건 + 재검증 27건 + 종결 확인 12건 반영) · **개정 2.2(2026-09-17 — P2 코드 리뷰 1회차 16건 반영: §4.2 각주²·§6.3·§7.1·§7.3·§7.4·§8.2·§9.1·§9.5·A.0·부록 C)** · **A-1~A-6 사용자 확정 2026-09-17: A-5 외 전부 추천안, A-5는 "AS 업무 권한(VIEWER 제외 USER 이상)"으로 수정**
