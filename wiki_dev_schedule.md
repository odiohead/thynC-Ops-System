...
- [x] Phase 7 — 부가 기능 (2026-06-10) — 태그/즐겨찾기/최근 본/검색/버전 히스토리/댓글/페이지 블록/인라인 mention
- [x] Phase 7.5 — 페이지 이동·복제·DnD (2026-06-10) — 트리 간 이동 모달 + 페이지 복제(하위 포함 옵션) + `@dnd-kit/core` 사이드바 드래그앤드롭
