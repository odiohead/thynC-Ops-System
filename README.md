...
| Method | Endpoint | 설명 |
|--------|----------|------|
| GET | `/api/as-receipts` | 목록 (statusId **복수 가능**·category·hospitalCode·접수일 기간·**tag 복수(AND, 2026-09-15)**·**overdue=1**(접수 2주 경과 미종결 — summary.overdue2w와 동일 정의)·q(코드·병원·시리얼)·페이징) |
