...
- 목록 상단 **요약 스트립**(진행 중/전체·이번 주 접수·평균 처리일(최근 3개월)·2주 경과 미처리) + **상태 체크박스 칩**(건수 표시·복수 선택 필터, 2026-09-07)
...
| GET | `/api/as-receipts/summary` | 목록 상단 요약 — 상태별 건수·이번 주(KST 월~) 접수·평균 처리일(최근 3개월 완료 건)·접수 2주 경과 미종결 (2026-09-07) |
