...
export async function PUT(request: NextRequest, { params }: Params) {
  ...
  const siteVisit = await prisma.siteVisit.update({
    ...
    data: {
      ...
      installPlanUrl: installPlanUrl !== undefined ? (installPlanUrl || null) : undefined,
      installPlanFileId: installPlanFileId !== undefined ? (installPlanFileId || null) : undefined,
      floorPlanUrl: floorPlanUrl !== undefined ? (floorPlanUrl || null) : undefined,
      floorPlanFileId: floorPlanFileId !== undefined ? (floorPlanFileId || null) : undefined,
